...
def create_parent(
    parent_data: ParentCreateData, parent_interface: DBInterface
) -> DataObject:
...
def update_parent(
    id: int, parent_data: ParentCreateData, parent_interface: DBInterface
) -> DataObject:
...
def get_children_of_parent(
    parent_id: int, parent_interface: DBInterface
) -> list[DataObject]:
    parent = parent_interface.read_by_id(parent_id)
